...
parser = argparse.ArgumentParser(description='Sequential_NN_for_time_series')
...
parser.add_argument('--previous_run_dir',type=str, help='A directory that contains a config.json and results.json for the same configuration space.', default='./old_run/')

args=parser.parse_args()

from imas_BOHB_worker import ImasWorker as worker
