# -*- coding: utf-8 -*-
"""ARIMA_with_csv_output

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OyTicp3qqOcFMcrDg5f_xZy8zkcPkL4W
"""
...
plt.savefig('ARIMA-decomposition.pdf', dpi=300)
plt.show()
...
plt.savefig('ARIMA-analysis.pdf', dpi=300)
plt.show()
...
plt.legend()
plt.savefig('ARIMA-one-step.pdf', dpi=300)
plt.show()
...
plt.legend()
plt.savefig('ARIMA-pred.pdf', dpi=300)
plt.show()
...
plt.legend()
plt.savefig('ARIMA_long_pred.pdf', dpi=300)
plt.show()
...
pred_uc.predicted_mean.to_csv('arima_forecast.csv')
pred.predicted_mean.to_csv('arima_one_step_ahead.csv')